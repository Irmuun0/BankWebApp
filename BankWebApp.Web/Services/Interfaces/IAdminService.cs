...
public interface IAdminService
{
    ...
    Task<AdminPagedResultDto<AdminUserDto>> GetUsersAsync(AdminUserFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
    Task<AdminUserProfileDto?> GetUserProfileAsync(long userId, CancellationToken cancellationToken = default);
    Task<(bool Success, string? ErrorMessage)> UpdateUserProfileAsync(long adminUserId, UpdateAdminUserProfileDto dto, CancellationToken cancellationToken = default);
    Task<(bool Success, string? ErrorMessage)> UnlockUserAsync(long adminUserId, long userId, CancellationToken cancellationToken = default);
    Task<(bool Success, string? ErrorMessage)> SetUserPasswordResetRequiredAsync(long adminUserId, long userId, bool isRequired, CancellationToken cancellationToken = default);
    Task<AdminPagedResultDto<AdminAccountDto>> GetAccountsAsync(AdminAccountFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
    ...
    Task<AdminPagedResultDto<AdminTransactionDto>> GetTransactionsAsync(AdminTransactionFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
    Task<AdminPagedResultDto<AdminAuditLogDto>> GetAuditLogsAsync(AdminAuditLogFilterDto? filter = null, int page = 1, int pageSize = 25, CancellationToken cancellationToken = default);
    ...
    Task<AdminFxIncomeReportDto> GetFxIncomeReportAsync(AdminFxIncomeFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
    Task<AdminSuspiciousDetectionReportDto> GetSuspiciousDetectionReportAsync(AdminSuspiciousDetectionReportFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
    ...
    Task<AdminPagedResultDto<AdminSuspiciousTransactionDto>> GetSuspiciousTransactionsAsync(AdminSuspiciousTransactionFilterDto? filter = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default);
